...
TEST(cfg_lit)
{
	...
	EXPECT_EQ(cfg_lit(NULL, STRV_NULL, CFG_MODE_UNKNOWN, STRV_NULL, NULL), 1);
	mem_oom(1);
	EXPECT_EQ(cfg_lit(&cfg, STRV_NULL, CFG_MODE_UNKNOWN, STRV_NULL, NULL), 1);
	EXPECT_EQ(cfg_lit(&cfg, STRV(""), CFG_MODE_UNKNOWN, STRV_NULL, NULL), 1);
	mem_oom(0);
	EXPECT_EQ(cfg_lit(&cfg, STRV_NULL, CFG_MODE_UNKNOWN, STRV_NULL, &lit), 0);
	EXPECT_EQ(lit, 0);
	cfg_free(&cfg);
	...
	log_set_quiet(0, 0);
	mem_oom(1);
	EXPECT_EQ(cfg_lit(&cfg, STRV_NULL, CFG_MODE_UNKNOWN, STRV(""), NULL), 1);
	mem_oom(0);
...
TEST(cfg_str)
{
	...
	EXPECT_EQ(cfg_str(NULL, STRV_NULL, CFG_MODE_UNKNOWN, STRV_NULL, NULL), 1);
	mem_oom(1);
	EXPECT_EQ(cfg_str(&cfg, STRV_NULL, CFG_MODE_UNKNOWN, STRV_NULL, NULL), 1);
	EXPECT_EQ(cfg_str(&cfg, STRV(""), CFG_MODE_UNKNOWN, STRV_NULL, NULL), 1);
	mem_oom(0);
	EXPECT_EQ(cfg_str(&cfg, STRV_NULL, CFG_MODE_UNKNOWN, STRV_NULL, &str), 0);
	EXPECT_EQ(str, 0);
	cfg_free(&cfg);
	...
	log_set_quiet(0, 0);
	mem_oom(1);
	EXPECT_EQ(cfg_str(&cfg, STRV_NULL, CFG_MODE_UNKNOWN, STRV(""), NULL), 1);
	mem_oom(0);
...
TEST(cfg_int)
{
	...
	mem_oom(1);
	EXPECT_EQ(cfg_int(&cfg, STRV_NULL, CFG_MODE_UNKNOWN, 0, NULL), 1);
	EXPECT_EQ(cfg_int(&cfg, STRV(""), CFG_MODE_UNKNOWN, 0, NULL), 1);
	mem_oom(0);
	EXPECT_EQ(cfg_int(&cfg, STRV_NULL, CFG_MODE_UNKNOWN, 0, &val), 0);
	EXPECT_EQ(val, 0);
	cfg_free(&cfg);
...
TEST(cfg_arr)
{
	...
	mem_oom(1);
	EXPECT_EQ(cfg_arr(&cfg, STRV_NULL, CFG_MODE_UNKNOWN, 0, NULL), 1);
	mem_oom(0);
	EXPECT_EQ(cfg_arr(&cfg, STRV_NULL, CFG_MODE_UNKNOWN, 0, &arr), 0);
	EXPECT_EQ(arr, 0);
...
TEST(cfg_add_var)
{
	...
	cfg_int(&cfg, STRV_NULL, CFG_MODE_UNKNOWN, 0, &i);
...
TEST(cfg_has_var)
{
	...
	cfg_root(&cfg, &root);
	cfg_int(&cfg, STRV("a"), CFG_MODE_UNKNOWN, 2, &i);
...
TEST(cfg_has_var_not_found)
{
	...
	cfg_root(&cfg, &root);
	cfg_str(&cfg, STRV("a"), CFG_MODE_UNKNOWN, STRV("int"), &str);
...
TEST(cfg_get_val_wrong_type)
{
	...
	cfg_str(&cfg, STRV("int"), CFG_MODE_UNKNOWN, STRV("a"), &var);
...
TEST(cfg_get_lit)
{
	...
	cfg_lit(&cfg, STRV("str"), CFG_MODE_UNKNOWN, STRV("val"), &var);
...
TEST(cfg_get_str)
{
	...
	cfg_str(&cfg, STRV("str"), CFG_MODE_UNKNOWN, STRV("val"), &var);
...
TEST(cfg_get_int)
{
	...
	cfg_int(&cfg, STRV("int"), CFG_MODE_UNKNOWN, 1, &var);
...
TEST(cfg_it_next)
{
	...
	cfg_arr(&cfg, STRV("arr"), CFG_MODE_UNKNOWN, 0, &arr);
	cfg_int(&cfg, STRV("str"), CFG_MODE_UNKNOWN, 0, &var0);
	cfg_int(&cfg, STRV("str"), CFG_MODE_UNKNOWN, 1, &var1);
...
TEST(cfg_it)
{
	...
	cfg_arr(&cfg, STRV("arr"), CFG_MODE_UNKNOWN, 0, &arr);
	cfg_int(&cfg, STRV("str"), CFG_MODE_UNKNOWN, 0, &vars[0]);
	cfg_int(&cfg, STRV("str"), CFG_MODE_UNKNOWN, 1, &vars[1]);
...
TEST(cfg_print)
{
	...
	cfg_lit(&cfg, STRV("lit"), CFG_MODE_UNKNOWN, STRV("val"), &var);
	cfg_add_var(&cfg, root, var);
	cfg_str(&cfg, STRV("str"), CFG_MODE_UNKNOWN, STRV("str"), &var);
	cfg_add_var(&cfg, root, var);
	cfg_int(&cfg, STRV("int"), CFG_MODE_UNKNOWN, 1, &var);
	cfg_add_var(&cfg, root, var);
	cfg_arr(&cfg, STRV("arr"), CFG_MODE_UNKNOWN, 0, &var);
	cfg_add_var(&cfg, root, var);
...
TEST(cfg_print_none)
{
	...
	cfg_root(&cfg, &root);
	cfg_int(&cfg, STRV("none"), CFG_MODE_UNKNOWN, 0, &none);
...
TEST(cfg_print_arr)
{
	...
	cfg_str(&cfg, STRV_NULL, CFG_MODE_UNKNOWN, STRV("str"), &var);
	cfg_add_var(&cfg, arr, var);
	cfg_int(&cfg, STRV_NULL, CFG_MODE_UNKNOWN, 1, &var);
	cfg_add_var(&cfg, arr, var);
	cfg_arr(&cfg, STRV_NULL, CFG_MODE_UNKNOWN, 0, &var);
	cfg_add_var(&cfg, arr, var);
...
TEST(cfg_print_root_str)
{
	...
	cfg_str(&cfg, STRV("str"), CFG_MODE_UNKNOWN, STRV("val"), &str);
...
TEST(cfg_print_mode)
{
	...
	cfg_root(&cfg, &root);
	cfg_str(&cfg, STRV("str"), __CFG_MODE_CNT, STRV("str"), &var);
	cfg_add_var(&cfg, root, var);
	cfg_int(&cfg, STRV("int"), CFG_MODE_ADD, 1, &var);
	cfg_add_var(&cfg, root, var);
	cfg_arr(&cfg, STRV("arr"), CFG_MODE_SUB, 0, &var);
	cfg_add_var(&cfg, root, var);
